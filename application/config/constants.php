...
defined('__PROJECT_NAME')      OR define('__PROJECT_NAME', 'cheonhasaju');
defined('__PROJECT_TITLE_NAME')      OR define('__PROJECT_TITLE_NAME', 'cheonhasaju');
...
defined('__VIEW_PATH_CONTENT_JS')      OR define('__VIEW_PATH_CONTENT_JS', '/front/content_js');
defined('__VIEW_PATH_COMMON_JS')      OR define('__VIEW_PATH_COMMON_JS', '/front/content_js/include/common_js');
defined('__VIEW_PATH_FOOTER')      OR define('__VIEW_PATH_FOOTER', '/front/include/footer');
